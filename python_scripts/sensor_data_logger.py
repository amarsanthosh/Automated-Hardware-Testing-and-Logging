...
# Database setup
DB_NAME = "C:\\Users\\sandyman\\playground\\AutomatedTestingProject\\Automated-Hardware-Testing-and-Logging\\python_scripts\\sensor_data.db"
...
def generate_sensor_data():
    ...
    temperature = round(random.uniform(20, 80), 2)  # Celsius
